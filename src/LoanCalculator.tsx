...
const LoanCalculatorForm = () => {
  ...
  return (
    <div className="card text-bg-light mb-3">
      ...
      <input id ="loanAmountInput" type="number" value={ loanAmount.toString() } onChange={(e) => setLoanAmount(parseInt(e.target.value))} />
      <span className='input-group-text'>SEK </span>
      </div>

      <div className='input-group mb-3'>
      <label htmlFor="interestRateInput" style={{ padding: '8px' }}>Interest Rate:  </label>
      <input id = "interestRateInput" type="number" value={ interestRate.toString()} onChange={(e) => setInterestRate(parseFloat(e.target.value))} />
      <span className='input-group-text'> % </span>
      </div>

      <div className='input-group mb-3'>
      <label htmlFor="repaymentPeriodInput" style={{ padding: '8px' }}>Repayment Period:  </label>
      <input id= "repaymentPeriodInput "type="number" value={ repaymentPeriodYears.toString() } onChange={(e) => setRepaymentPeriodYears(parseInt(e.target.value))} />
      ...
      { monthlyPayment > 0 && <p id= "monthlyPayment" > Monthly Payment: { monthlyPayment.toString() } SEK </p>}
      </div>
